...
def run_infinite_post_data_loop():
    while True:
        ...
        with engine.connect() as connection:
            ...
            invoke_url = "https://nsfytprkye.execute-api.us-east-1.amazonaws.com/demo/streams/streaming-0a4ac73a0561-pin/record"
            payload = json.dumps({
                "StreamName": "streaming-0a4ac73a0561-pin",
                "Data": {
            ...
            payload = json.dumps({
                "StreamName": "streaming-0a4ac73a0561-geo",
                "Data": {
                    "ind": geo_result["ind"],
            ...
            payload = json.dumps({
                "StreamName": "streaming-0a4ac73a0561-user", 
                "Data": {
                    "ind": user_result["ind"],
